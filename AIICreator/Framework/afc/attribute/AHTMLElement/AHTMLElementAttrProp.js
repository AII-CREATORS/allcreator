...
AHTMLElementAttrProp = class AHTMLElementAttrProp extends BaseProp
{
	constructor()
	{
		super()
    ...
    init(context, evtListener)
    {
        ...
        //	AHTMLElement 만의 추가적인 설정 화면을 제작합니다.
        //	프로젝트뷰에서 /afc/attribute/AHTMLElement 폴더의 
        //	AHTMLElementAttrItems.attr 파일을 수정하여 작업합니다.

        this.makeAttrItem('afc', 'AHTMLElement')
    }
