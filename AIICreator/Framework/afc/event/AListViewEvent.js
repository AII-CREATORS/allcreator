...
AListViewEvent.prototype.defaultAction = function()
{
    this._select();
};
...
AListViewEvent.prototype._refresh = function()
{
	...
	ri.init(alistview, alistview.scrollArea);
...
AListViewEvent.prototype._scroll = function()
{
	...
	var alistview = this.acomp, oldScrollTop = alistview.scrollArea.scrollTop;
	
	alistview.scrollArea.addEventListener('scroll', function(e)
	{
...
AListViewEvent.prototype._select = function()
{
	...
	AEvent.bindEvent(ele, AEvent.ACTION_DOWN, function(e)
	{
		...
		//배경을 터치한 경우
		if(e.target===alistview.scrollArea) 
		{
