...
ATextAreaEvent.prototype._focus = function()
{
	...
	atextarea.element.addEventListener('focus', function(e)
	{
        ...
        atextarea.changeState('data-style-focus')
...
ATextAreaEvent.prototype._blur = function()
{
	...
	atextarea.element.addEventListener('blur', function(e)
	{
        atextarea.changeState(null, 'data-style-focus')
...
ATextAreaEvent.prototype._change = function()
{
	...
	this.acomp.element.addEventListener('keyup', function(e)
	{
		thisObj.changeProc();
	});
...
ATextAreaEvent.prototype._keydown = function()
{
	...
	acomp.element.addEventListener('keydown', function(e)
	{
...
ATextAreaEvent.prototype._keyup = function()
{
	...
	acomp.element.addEventListener('keyup', function(e)
	{
