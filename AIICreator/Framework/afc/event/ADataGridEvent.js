...
ADataGridEvent.prototype.clearEvtObj = function()
{
    this.evtObj = {};
}
...
ADataGridEvent.prototype._onGridSelect = function(acomp, info, e)
{
    ...
    if(this.selectBind && this.evtObj)
    {
        ...
        {
            if(!this.acomp.option.isSameSelectEvent && this.evtObj.rowInx==curEvtObj.rowInx) return;
        }
        else 
        {
            if(!this.acomp.option.isSameSelectEvent && this.evtObj.rowInx==curEvtObj.rowInx && this.evtObj.colInx==curEvtObj.colInx) return;
        }
