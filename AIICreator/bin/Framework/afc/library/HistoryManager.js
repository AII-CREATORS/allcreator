...
function HistoryManager()
{
	...
	this.actData = [];				//
	this.savedOffset = -1;		//저장 시점의 offset
}
...
//현재 offset을 저장 시점으로 기록
HistoryManager.prototype.markSaved = function()
{
	this.savedOffset = this.offset;
};

//현재 offset이 저장 시점과 동일한지 확인
HistoryManager.prototype.isAtSavedState = function()
{
	return this.offset === this.savedOffset;
};
