...
BackupManager.prototype.create = function(delegator, maxRow, restoreCount)
{
	...
	this.headStack = document.createElement('div');
	this.tailStack = document.createElement('div');
};
...
BackupManager.prototype.backupHead = function(row) { this.headStack.appendChild(row); };
BackupManager.prototype.clearHead = function() { this.headStack.innerHTML = ''; };
BackupManager.prototype.restoreHead = function() { return this.headStack.lastElementChild; };
...
BackupManager.prototype.backupTail = function(row) { this.tailStack.appendChild(row); };
BackupManager.prototype.clearTail = function() { this.tailStack.innerHTML = ''; };
BackupManager.prototype.restoreTail = function() { return this.tailStack.lastElementChild; };
...
BackupManager.prototype.checkHeadBackup = function()
{
	...
	if(resCount>0)
	{
		...
		this.contentEle.prepend(frag);

		//this._plusBackupScroll(resCount/this.itemContentCnt);
		this._plusBackupScroll(_TinyDom.position(first).top);
...
BackupManager.prototype.checkTailBackup = function()
{
	...
	if(resCount>0)
	{
		...
		for(var i=0; i<resCount; i++)
		{
			...
			frag.appendChild(this.restoreTail());
