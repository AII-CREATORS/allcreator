...
ASplitView.prototype.setSplitView = async function(inx, view)
{
	...
	if(typeof(view)=='string') view = await AView.createView(item, view, this);

	else AView.setViewInItem(view, item, this);

	//셋팅되는 뷰는 가득차게 한다.
    Object.assign(view.element.style, { left:'0px', top:'0px', width:'100%', height:'100%' });
...
ASplitView.prototype.changeDirection = function()
{
	this.splitter.changeDirection(this.setSplitView, this.getSplitView);
    this.updatePosition();
};

ASplitView.prototype.getSplitDir = function()
{
	return this.splitter.getSplitDir();
};

ASplitView.prototype.getSplitCount = function()
{
