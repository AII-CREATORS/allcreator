...
{
    tag: '<div data-base="ASwitchButton" data-class="ASwitchButton" class="ASwitchButton-Style"><span></span></div>',
...
ASwitchButton.prototype.init = function(context, evtListener)
{
	...
	this.barEl = this.element.firstChild;
    ...
    this.backOnStyle = this.getAttr('data-style-on')
...
ASwitchButton.prototype.setValue = function(isOn)
{
    ...
    if(this.isOn)
    {
        ...
        if(this.backOnStyle) this.addClass(this.backOnStyle);
    }
    else
    {
        ...
        if(this.backOnStyle) this.removeClass(this.backOnStyle);
...
ASwitchButton.prototype._setDataStyleObj = function(styleObj)
{
	for(var p in styleObj)
	{
		...
		{
			if(p == "data-style-on") this.setAttr(p, styleObj[p]);
